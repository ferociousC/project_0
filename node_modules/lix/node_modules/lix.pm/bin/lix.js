...
"Km3U1IerHHABRXo51tblO6ej0AV/GNWGqosNU+5CywM=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"dyGyrvhjWIVvJmWhDvXGsglWKGrRcWHt9JmHoahuAXg=":
function (require, module, exports, __dirname, __filename) {
...
var haxe_Http = function(url) {
	...
	var this11 = { };
	this.headers = this11;
	this.url = tink__$Url_Url_$Impl_$.parse(url);
};
...
haxe_Http.prototype = {
	...
	,request: function(post) {
		...
		if(params == "") {
			...
			var v = params;
			tmp = (this.url.query == null ? "?" : "&") + v;
		} else if(post == true) {
			tmp = "";
		} else {
			var v1 = params;
			tmp = (this.url.query == null ? "?" : "&") + v1;
		}
		...
		(_g == null ? js_node_Http.request : _g == "https" ? js_node_Https.request : js_node_Http.request)({ host : this.url.host, protocol : this.url.scheme + ":", method : post ? "POST" : "GET", path : (this1.query == null ? this1.path : this1.path + "?" + this1.query) + tmp, headers : this.headers},function(res) {
			var parts = [];
			res.on("end",function() {
...
var haxeshim_ServerKind = $hxClasses["haxeshim.ServerKind"] = { __ename__ : ["haxeshim","ServerKind"], __constructs__ : ["Port","Stdio"] };
...
var haxeshim_StdioState = $hxClasses["haxeshim.StdioState"] = { __ename__ : ["haxeshim","StdioState"], __constructs__ : ["AwaitingHeader","AwaitingData"] };
...
$hxClasses["haxeshim.CompilerServer"] = haxeshim_CompilerServer;
...
$hxClasses["haxeshim._LibResolution.LibResolution_Impl_"] = haxeshim__$LibResolution_LibResolution_$Impl_$;
...
var lix_client_ArchiveKind = $hxClasses["lix.client.ArchiveKind"] = { __ename__ : ["lix","client","ArchiveKind"], __constructs__ : ["Zip","Tar"] };
...
$hxClasses["lix.client.Cli"] = lix_client_Cli;
lix_client_Cli.__name__ = ["lix","client","Cli"];
lix_client_Cli.main = function() {
	lix_client_Cli.dispatch(process.argv.slice(2));
};
lix_client_Cli.dispatch = function(args) {
	var version = ({ scripts : { build : "haxe lix.client.hxml && npm run bundle && mv bin/lix.bundle.js bin/lix.js", noderify : "noderify", bundle : "noderify bin/lix.js > bin/lix.bundle.js"}, repository : { url : "git+https://github.com/lix-pm/lix.git", type : "git"}, devDependencies : { noderify : "=3.0.2", tar : "=4.0.2", yauzl : "=2.6.0"}, haxeDependencies : { switchx : "*"}, files : ["bin"], bin : { lix : "bin/lix.js"}, keywords : ["haxe"], version : "0.14.0", author : "back2dos", description : "lix - Libraries for haXe", homepage : "https://github.com/lix-pm/lix#readme", license : "MIT", name : "lix.pm", bugs : { url : "https://github.com/lix-pm/lix/issues"}}).version;
	...
	args = switchx_Command.expand(args,[switchx__$Command_CommandExpander_$Impl_$.ofString("+tink install github:haxetink/tink_${0}"),switchx__$Command_CommandExpander_$Impl_$.ofString("+coco install github:MVCoconut/coconut.${0}"),switchx__$Command_CommandExpander_$Impl_$.ofString("+lib install haxelib:${0}")]);
	var scope = haxeshim_Scope.seek({ cwd : $global ? haxeshim_Scope.DEFAULT_ROOT : null});
	var switchxApi = new switchx_Switchx(scope,silent);
	...
	var sources = [lix_client_sources_Web,lix_client_sources_Haxelib,github1,gitlab1,new lix_client_sources_Git(github1,gitlab1)];
	...
	var resolve = function(url) {
		...
		if(_g31 == null) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Unknown scheme in url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "Cli.hx", lineNumber : 65, className : "lix.client.Cli", methodName : "dispatch"})));
		} else {
			var v2 = _g31;
			return v2.processUrl(url);
		}
	};
	var client = new lix_client_Client(scope,resolve,function(_) {
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(501,"not implemented",{ fileName : "Cli.hx", lineNumber : 73, className : "lix.client.Cli", methodName : "dispatch"})));
	},silent ? function(_1) {
	} : Sys.println,force,silent);
	var switchxCli = new switchx_Cli(switchxApi,force);
	var switchxCommands = switchxCli.makeCommands();
	var fromSwitchx = function(name) {
		var _g32 = 0;
		while(_g32 < switchxCommands.length) {
			var cmd = switchxCommands[_g32];
			++_g32;
			if(switchx__$Command_CommandName_$Impl_$.eq(cmd.name,name)) {
				return cmd;
			}
		}
		throw new js__$Boot_HaxeError("assert");
	};
	switchx_Command.dispatch(args,"lix - Libraries for haXe (v" + version + ")",[new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("install"),"<url> [as <lib[#ver]>]","install lib from specified url",function(args1) {
		if(scope.isGlobal && !$global) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Current scope is global. Please use --global if you intend to install globally, or create a local scope.",{ fileName : "Cli.hx", lineNumber : 93, className : "lix.client.Cli", methodName : "dispatch"})));
		} else {
			switch(args1.length) {
			case 0:
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Missing url",{ fileName : "Cli.hx", lineNumber : 106, className : "lix.client.Cli", methodName : "dispatch"})));
			case 1:
				var library = args1[0];
				if(tink__$Url_Url_$Impl_$.parse(library).scheme == null) {
					return client.install(library);
				} else {
					var url1 = args1[0];
					return client.installUrl(tink__$Url_Url_$Impl_$.parse(url1));
				}
				break;
			case 2:
				if(args1[0] == "haxe") {
					var version1 = args1[1];
					return tink_core__$Promise_Promise_$Impl_$.next(switchxCli.download(version1),$bind(switchxCli,switchxCli.switchTo));
				} else {
					...
					var f = $bind(client,client.install);
					var a1 = library1;
			...
			case 3:
				if(args1[1] == "as") {
					...
					return client.installUrl(this2,this3);
				} else {
					var v3 = args1;
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 107, className : "lix.client.Cli", methodName : "dispatch"})));
				}
				break;
			default:
				var v4 = args1;
	...
	}),new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("install haxe"),"<version>|<alias>","install specified haxe version",null),new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("use"),"haxe <alias>|<version>","use specified haxe version",function(args2) {
		if(args2.length == 2) {
			if(args2[0] == "haxe") {
				var version2 = args2[1];
				return tink_core__$Promise_Promise_$Impl_$.next(switchxApi.resolveInstalled(switchx__$Version_UserVersion_$Impl_$.ofString(version2)),$bind(switchxCli,switchxCli.switchTo));
			} else {
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "Cli.hx", lineNumber : 113, className : "lix.client.Cli", methodName : "dispatch"})));
			}
		} else {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "Cli.hx", lineNumber : 113, className : "lix.client.Cli", methodName : "dispatch"})));
		}
	}),fromSwitchx("list")["as"](switchx__$Command_CommandName_$Impl_$.ofString("haxe-versions"),"lists currently downloaded haxe versions"),fromSwitchx("scope"),new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("download"),"[<url[#lib[#ver]]>]","download lib from url if specified,\notherwise download missing libs",function(args3) {
		switch(args3.length) {
		case 0:
			return tink_core__$Future_Future_$Impl_$.next(switchx_Cli.ensureNeko(haxeshim_Scope.seek()),function(_2) {
				var this4 = switchxApi.resolveOnline(switchx__$Version_UserVersion_$Impl_$.ofString(scope.config.version));
				var f1 = $bind(switchxApi,switchxApi.download);
		...
		case 1:
			var _hx_tmp = tink__$Url_Url_$Impl_$.parse(args3[0]);
			var url3 = _hx_tmp;
			return tink_core__$Promise_Promise_$Impl_$.noise(client.downloadUrl(url3));
		case 3:
			switch(args3[1]) {
			case "as":
				var legacy = args3[2];
				...
				var shorten = function(s1) {
					if(s1.length > 40) {
						return HxOverrides.substr(s1,0,37) + "...";
					} else {
						return s1;
					}
				};
				if(sys_FileSystem.exists(absTarget)) {
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"`download <url> as <ver>` is no longer supported",{ fileName : "Cli.hx", lineNumber : 128, className : "lix.client.Cli", methodName : "dispatch"})));
				} else {
					var v5 = "[WARN]: Processing obsolete `download " + args3.map(shorten).join(" ") + "`.\n        Please reinstall library in a timely manner!\n\n";
					process.stdout.write(Std.string(v5));
					process.stdout.write("\n");
					return tink_core__$Promise_Promise_$Impl_$.noise(tink_core__$Promise_Promise_$Impl_$.next(client.downloadUrl(tink__$Url_Url_$Impl_$.parse(url4),{ into : target}),function(a) {
			...
			case "into":
				var dir = args3[2];
				var url5 = args3[0];
				return tink_core__$Promise_Promise_$Impl_$.noise(client.downloadUrl(tink__$Url_Url_$Impl_$.parse(url5),{ into : dir}));
			default:
				var v6 = args3;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 158, className : "lix.client.Cli", methodName : "dispatch"})));
			}
			break;
		default:
			var v7 = args3;
	...
	}),new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("run"),"lib ...args","run a library",function(args4) {
		if(args4.length == 0) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no library specified",{ fileName : "Cli.hx", lineNumber : 162, className : "lix.client.Cli", methodName : "dispatch"})));
		} else {
			var args5 = args4;
			return tink_core__$Promise_Promise_$Impl_$.noise(tink_core__$Promise_Promise_$Impl_$.next(scope.getLibCommand(args5),function(cmd1) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(cmd1()));
			}));
		}
	}),new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("build"),"...args","build through lix (useful if haxeshim is not installed)",function(args6) {
		new haxeshim_HaxeCli(scope).dispatch(args6);
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise));
	}),new switchx_Command(["--version","-v"],"","print version",function(args7) {
		if(args7.length > 0) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 174, className : "lix.client.Cli", methodName : "dispatch"})));
		} else {
			process.stdout.write(version == null ? "null" : "" + version);
			process.stdout.write("\n");
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise));
		}
	}),new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("run-haxelib"),"path ...args","invoke a haxelib at a given path following haxelib's conventions",function(args8) {
		if(args8.length == 0) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no path supplied",{ fileName : "Cli.hx", lineNumber : 182, className : "lix.client.Cli", methodName : "dispatch"})));
		} else {
			return lix_client_sources_Haxelib.runLib(scope,args8);
		}
	})],[]).handle(switchx_Command.reportOutcome);
};
var lix_client_Client = function(scope,urlToJob,resolver,log,force,silent) {
	this.scope = scope;
...
$hxClasses["lix.client.Client"] = lix_client_Client;
lix_client_Client.__name__ = ["lix","client","Client"];
lix_client_Client.prototype = {
	...
	,downloadArchive: function(a,__tink_tmp7) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(a,function(a1) {
			...
			if(exists && !_gthis.force) {
				...
				var _g1 = a1.kind;
				if(_g1 == null) {
					tmp = switchx_Download.archive;
				} else {
					switch(_g1[1]) {
					case 0:
						tmp = switchx_Download.zip;
						break;
					case 1:
						tmp = switchx_Download.tar;
						break;
					}
				}
				return tink_core__$Promise_Promise_$Impl_$.next(tmp(tink__$Url_Url_$Impl_$.toString(a1.url),0,_gthis.scope.haxeshimRoot + "/downloads/download@" + new Date().getTime(),!_gthis.silent),function(dir) {
	...
	,installArchive: function(a,$as,withHaxeLibDependencies) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(this.downloadArchive(a),function(a1) {
			...
			if(name == null) {
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Could not determine library name for " + tink__$Url_Url_$Impl_$.toString(a1.job.normalized),{ fileName : "Client.hx", lineNumber : 99, className : "lix.client.Client", methodName : "installArchive"})));
			}
...
var lix_client_sources_Git = function(github,gitlab) {
	this.github = github;
	this.gitlab = gitlab;
};
	...
	,processUrl: function(url) {
		...
		if(StringTools.startsWith(gh,"https://github.com")) {
			...
			if(StringTools.startsWith(gl,"https://gitlab.com")) {
				...
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"not implemented",{ fileName : "Git.hx", lineNumber : 29, className : "lix.client.sources.Git", methodName : "processUrl"})));
			}
		}
	}
...
lix_client_sources_GitLab.prototype = {
	...
	,grabCommit: function(owner,project,version,options) {
		return tink_core__$Promise_Promise_$Impl_$.next(switchx_Download.text("https://" + lix_client_sources_GitLab.host(options) + "/api/v4/projects/" + owner + "%2F" + project + "/repository/commits/" + version + "?" + this.privateToken),function(s) {
			try {
...
lix_client_sources_Haxelib.processUrl = function(url) {
	...
	if(_g == null) {
		...
		if(_hx_tmp.length == 1) {
			...
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid haxelib url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "Haxelib.hx", lineNumber : 16, className : "lix.client.sources.Haxelib", methodName : "processUrl"})));
		}
	}
};
...
lix_client_sources_Haxelib.resolveVersion = function(name,options) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
		...
		cnx.setErrorHandler(function(e) {
			var tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to get version information from haxelib because " + e,e,{ fileName : "Haxelib.hx", lineNumber : 45, className : "lix.client.sources.Haxelib", methodName : "resolveVersion"}));
			cb(tmp);
		});
...
lix_client_sources_Haxelib.installDependencies = function(haxelibs,client,skip) {
	var _g = [];
	var _g1 = 0;
	var _g2 = Reflect.fields(haxelibs);
	while(_g1 < _g2.length) {
		...
		_g.push(tink_core__$Future_Future_$Impl_$.async((function(name1) {
			return function(cb) {
				...
				client.log("Installing dependency " + name1[0]);
				var this1;
				...
				if(_g3 == null) {
					...
					this1 = client.installArchive(this3,null,true);
				} else {
					var v1 = _g3;
					this1 = client.installUrl(version,new lix_client_LibVersion(haxe_ds_Option.Some(name1[0]),haxe_ds_Option.None));
				}
				this1.handle((function(name3) {
					return function(o) {
						...
						if(o[1] == 1) {
							var e = o[2];
							tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(e.code,"" + name3[0] + ": " + e.message,e.data,{ fileName : "Haxelib.hx", lineNumber : 70, className : "lix.client.sources.Haxelib", methodName : "installDependencies"}));
						} else {
							tmp = o;
						}
						cb(tmp);
	...
	var ret1 = tink_core__$Future_Future_$Impl_$.ofMany(ret).map(function(results) {
		...
		if(errors.length == 0) {
			...
			return tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to install dependencies:\n  " + errors.map(function(e2) {
				return e2.message;
			}).join("\n  "),errors,{ fileName : "Haxelib.hx", lineNumber : 90, className : "lix.client.sources.Haxelib", methodName : "installDependencies"}));
		}
	});
	return ret1.gather();
};
lix_client_sources_Haxelib.runLib = function(scope,args) {
	args = args.map($bind(scope,scope.interpolate));
	var path = args.shift();
	return tink_core__$Promise_Promise_$Impl_$.noise(tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(haxeshim_Fs.get("" + path + "/haxelib.json",{ fileName : "Haxelib.hx", lineNumber : 98, className : "lix.client.sources.Haxelib", methodName : "runLib"}),function(s) {
		var o;
		try {
			o = tink_core_Outcome.Success(JSON.parse(s).mainClass);
		} catch( e ) {
			if (e instanceof js__$Boot_HaxeError) e = e.val;
			o = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"failed to parse haxelib.json",e,{ fileName : "Haxelib.hx", lineNumber : 103, className : "lix.client.sources.Haxelib", methodName : "runLib"}));
		}
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(o));
	}),function(mainClass) {
		if(mainClass == null) {
			var o1 = ["" + path + "/run.n"].concat(args).concat([process.cwd()]);
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(haxeshim_Exec.sync("neko",path,o1,haxeshim__$Env_Env_$Impl_$.ofVars({ HAXELIB_RUN : "1"}))));
		} else {
			var v = mainClass;
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"mainClass support not implemented yet",{ fileName : "Haxelib.hx", lineNumber : 110, className : "lix.client.sources.Haxelib", methodName : "runLib"})));
		}
	}));
};
...
var switchx_Cli = function(api,force) {
	this.api = api;
	this.force = force;
};
$hxClasses["switchx.Cli"] = switchx_Cli;
switchx_Cli.__name__ = ["switchx","Cli"];
...
switchx_Cli.prototype = {
	download: function(version) {
		...
		switch(_g[1]) {
		case 3:case 4:
			this1 = this.api.resolveInstalled(switchx__$Version_UserVersion_$Impl_$.ofString(version));
			break;
		default:
			this1 = tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"" + version + " needs to be resolved online",{ fileName : "Cli.hx", lineNumber : 82, className : "switchx.Cli", methodName : "download"})));
		}
		var f = function(_) {
			_gthis.log("Looking up Haxe version \"" + version + "\" online");
			return tink_core__$Promise_Promise_$Impl_$.next(_gthis.api.resolveOnline(switchx__$Version_UserVersion_$Impl_$.ofString(version)),function(r) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(ret.gather(),function(r1) {
			return tink_core__$Promise_Promise_$Impl_$.next(_gthis.api.download(r1,{ force : _gthis.force}),function(wasDownloaded) {
				_gthis.log(!wasDownloaded ? "  ... already downloaded!" : "");
	...
	,switchTo: function(version) {
		var _gthis = this;
		return tink_core__$Promise_Promise_$Impl_$.next(this.api.switchTo(version),function(v) {
			var tmp = "Now using " + switchx__$Version_ResolvedVersion_$Impl_$.toString(version);
			_gthis.log(tmp);
	...
	,makeCommands: function() {
		...
		return [new switchx_Command(switchx__$Command_CommandName_$Impl_$.ofString("install"),"[<version>]","installs the version if specified, otherwise\ninstalls the currently configured version",function(args) {
			switch(args.length) {
			case 0:
				return tink_core__$Promise_Promise_$Impl_$.next(_gthis.download(scope.config.version),$bind(_gthis,_gthis.switchTo));
			case 1:
				var v = args[0];
				return tink_core__$Promise_Promise_$Impl_$.next(_gthis.download(v),$bind(_gthis,_gthis.switchTo));
			default:
				var v1 = args;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"command `install` accepts one argument at most (i.e. the version)",{ fileName : "Cli.hx", lineNumber : 124, className : "switchx.Cli", methodName : "makeCommands"})));
			}
			...
			switch(args1.length) {
			case 0:
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"not enough arguments",{ fileName : "Cli.hx", lineNumber : 130, className : "switchx.Cli", methodName : "makeCommands"})));
			case 1:
				var v2 = args1[0];
				return tink_core__$Promise_Promise_$Impl_$.noise(_gthis.download(v2));
			default:
				var v3 = args1;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 131, className : "switchx.Cli", methodName : "makeCommands"})));
			}
			...
			case 1:
				var v4 = args2[0];
				return tink_core__$Promise_Promise_$Impl_$.next(_gthis.api.resolveInstalled(switchx__$Version_UserVersion_$Impl_$.ofString(v4)),$bind(_gthis,_gthis.switchTo));
			default:
				var v5 = args2;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 138, className : "switchx.Cli", methodName : "makeCommands"})));
			}
			...
			if(_g == null) {
				...
				case "create":
					...
					case 1:
						var v6 = _g1[0];
						p = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(haxeshim__$LibResolution_LibResolution_$Impl_$.parse(v6)));
						break;
					default:
						p = tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 162, className : "switchx.Cli", methodName : "makeCommands"})));
					}
				...
				case "delete":
					if(scope.isGlobal) {
						return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Cannot delete global scope",{ fileName : "Cli.hx", lineNumber : 172, className : "switchx.Cli", methodName : "makeCommands"})));
					} else {
						scope["delete"]();
						_gthis.log("deleted scope in " + scope.scopeDir);
						return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise));
					}
					break;
				case "set":
					...
					switch(_g2.length) {
					case 0:
						return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"not enough arguments",{ fileName : "Cli.hx", lineNumber : 145, className : "switchx.Cli", methodName : "makeCommands"})));
					case 1:
						var v7 = _g2[0];
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_OutcomeTools.map(haxeshim__$LibResolution_LibResolution_$Impl_$.parse(v7),function(v8) {
							scope.reconfigure({ version : scope.config.version, resolveLibs : v8});
							return tink_core_Noise.Noise;
						})));
					default:
						var v9 = _g2;
						return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 156, className : "switchx.Cli", methodName : "makeCommands"})));
					}
					break;
				default:
					var v10 = _g;
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Invalid arguments",{ fileName : "Cli.hx", lineNumber : 185, className : "switchx.Cli", methodName : "makeCommands"})));
				}
			}
			...
			if(args4.length == 0) {
				return tink_core__$Promise_Promise_$Impl_$.next(_gthis.api.officialInstalled(switchx_PickOfficial.IncludePrereleases),function(o) {
					return tink_core__$Promise_Promise_$Impl_$.next(_gthis.api.nightliesInstalled(),function(n) {
						...
						process.stdout.write("");
						process.stdout.write("\n");
						var v11 = "Using " + switchx__$Version_UserVersion_$Impl_$.toString(switchx__$Version_UserVersion_$Impl_$.ofString(scope.config.version));
						process.stdout.write(Std.string(v11));
						process.stdout.write("\n");
						process.stdout.write("");
						process.stdout.write("\n");
						...
						if($iterator(n)().hasNext()) {
							...
							while(v15.hasNext()) {
								var v16 = v15.next();
								var v17 = highlight(v16.hash) + DateTools.format(v16.published,"  (%Y-%m-%d %H:%M)");
								process.stdout.write(Std.string(v17));
								process.stdout.write("\n");
							}
						}
						process.stdout.write("");
				...
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"command `list` does expect arguments",{ fileName : "Cli.hx", lineNumber : 224, className : "switchx.Cli", methodName : "makeCommands"})));
			}
		})];
	}
	,__class__: switchx_Cli
};
var switchx__$Command_CommandExpander_$Impl_$ = {};
$hxClasses["switchx._Command.CommandExpander_Impl_"] = switchx__$Command_CommandExpander_$Impl_$;
switchx__$Command_CommandExpander_$Impl_$.__name__ = ["switchx","_Command","CommandExpander_Impl_"];
...
$hxClasses["switchx._Command.CommandName_Impl_"] = switchx__$Command_CommandName_$Impl_$;
switchx__$Command_CommandName_$Impl_$.__name__ = ["switchx","_Command","CommandName_Impl_"];
...
$hxClasses["switchx.Command"] = switchx_Command;
switchx_Command.__name__ = ["switchx","Command"];
...
switchx_Command.dispatch = function(args,title,commands,extras) {
	...
	if(_g == null) {
		...
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(404,"unknown command " + command,{ fileName : "Command.hx", lineNumber : 191, className : "switchx.Command", methodName : "dispatch"})));
	}
};
switchx_Command.prototype = {
	'as': function(alias,doc) {
		return new switchx_Command(alias,this.args,doc == null ? this.doc : doc,this.exec);
	}
	,__class__: switchx_Command
};
var switchx_Download = function() { };
$hxClasses["switchx.Download"] = switchx_Download;
switchx_Download.__name__ = ["switchx","Download"];
...
var switchx_PickOfficial = $hxClasses["switchx.PickOfficial"] = { __ename__ : ["switchx","PickOfficial"], __constructs__ : ["StableOnly","IncludePrereleases"] };
...
$hxClasses["switchx.Switchx"] = switchx_Switchx;
switchx_Switchx.__name__ = ["switchx","Switchx"];
...
$hxClasses["switchx.Tar"] = switchx_Tar;
switchx_Tar.__name__ = ["switchx","Tar"];
...
var switchx_UserVersionData = $hxClasses["switchx.UserVersionData"] = { __ename__ : ["switchx","UserVersionData"], __constructs__ : ["UEdge","ULatest","UStable","UNightly","UOfficial","UCustom"] };
...
$hxClasses["switchx._Version.Official_Impl_"] = switchx__$Version_Official_$Impl_$;
switchx__$Version_Official_$Impl_$.__name__ = ["switchx","_Version","Official_Impl_"];
...
var switchx_ResolvedUserVersionData = $hxClasses["switchx.ResolvedUserVersionData"] = { __ename__ : ["switchx","ResolvedUserVersionData"], __constructs__ : ["RNightly","ROfficial","RCustom"] };
...
$hxClasses["switchx._Version.ResolvedVersion_Impl_"] = switchx__$Version_ResolvedVersion_$Impl_$;
switchx__$Version_ResolvedVersion_$Impl_$.__name__ = ["switchx","_Version","ResolvedVersion_Impl_"];
...
$hxClasses["switchx._Version.UserVersion_Impl_"] = switchx__$Version_UserVersion_$Impl_$;
switchx__$Version_UserVersion_$Impl_$.__name__ = ["switchx","_Version","UserVersion_Impl_"];
