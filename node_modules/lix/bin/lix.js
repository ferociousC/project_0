...
"6lzMvJGs7XweRm1Ek5JmUGFYiYqG8C+WzFDn6QeoykQ=":
function (require, module, exports, __dirname, __filename) {
...
lix_cli_Cli.dispatch = function(args) {
	...
	var sources = [lix_client_sources_Web,lix_client_sources_Haxelib,github1,gitlab,new lix_client_sources_Git(github1,gitlab,scope)];
	...
	var resolve = function(url) {
		...
		if(_g21 == null) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Unknown scheme in url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "Cli.hx", lineNumber : 46, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
			var v2 = _g21;
	...
	var libs = new lix_client_Libraries(scope,resolve,function(_1) {
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(501,"not implemented",{ fileName : "Cli.hx", lineNumber : 57, className : "lix.cli.Cli", methodName : "dispatch"})));
	},log,force,silent);
	...
	var this3 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("install"),"<url> [as <lib[#ver]>]","install lib from specified url",function(args3) {
		if(scope.isGlobal && !$global) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Current scope is global. Please use --global if you intend to install globally, or create a local scope with `lix scope create`.",{ fileName : "Cli.hx", lineNumber : 68, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
			switch(args3.length) {
			case 0:
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Missing url",{ fileName : "Cli.hx", lineNumber : 81, className : "lix.cli.Cli", methodName : "dispatch"})));
			case 1:
				var library = args3[0];
			...
			case 3:
				if(args3[1] == "as") {
					...
					var v3 = args3;
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 82, className : "lix.cli.Cli", methodName : "dispatch"})));
				}
				break;
			default:
				var v4 = args3;
	...
	var this8 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("use"),"haxe <alias>|<version>","use specified haxe version",function(args4) {
		if(args4.length == 2) {
			if(args4[0] == "haxe") {
				...
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "Cli.hx", lineNumber : 88, className : "lix.cli.Cli", methodName : "dispatch"})));
			}
		} else {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "Cli.hx", lineNumber : 88, className : "lix.cli.Cli", methodName : "dispatch"})));
		}
	...
	var this10 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("scope"),"[create|delete]","creates or deletes the current scope or\ninspects it if no argument is supplied",function(args5) {
		...
		case 1:
			...
			case "delete":
				if(scope.isGlobal) {
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Cannot delete global scope",{ fileName : "Cli.hx", lineNumber : 102, className : "lix.cli.Cli", methodName : "dispatch"})));
				} else {
					scope["delete"]();
			...
			default:
				var v5 = args5;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Invalid arguments",{ fileName : "Cli.hx", lineNumber : 114, className : "lix.cli.Cli", methodName : "dispatch"})));
			}
			break;
		default:
			var v6 = args5;
	...
	var this11 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("haxe-versions"),"","lists currently downloaded versions",function(args6) {
		if(args6.length == 0) {
			...
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"command `list` does expect arguments",{ fileName : "Cli.hx", lineNumber : 151, className : "lix.cli.Cli", methodName : "dispatch"})));
		}
	});
	var this12 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("download"),"[<url[#lib[#ver]]>]","download lib from url if specified,\notherwise download missing libs",function(args7) {
		...
		case 2:
			if(args7[0] == "haxe") {
				...
				var v13 = args7;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 196, className : "lix.cli.Cli", methodName : "dispatch"})));
			}
			break;
		case 3:
			switch(args7[1]) {
			case "as":
				...
				if(sys_FileSystem.exists(absTarget)) {
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"`download <url> as <ver>` is no longer supported",{ fileName : "Cli.hx", lineNumber : 167, className : "lix.cli.Cli", methodName : "dispatch"})));
				} else {
	...
	var this14 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("run"),"lib ...args","run a library",function(args8) {
		if(args8.length == 0) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no library specified",{ fileName : "Cli.hx", lineNumber : 200, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
			var args9 = args8;
	...
	var this15 = new lix_cli_Command(["--version","-v"],"","print version",function(args10) {
		if(args10.length > 0) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 206, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
	...
	lix_cli_Command.dispatch(args,this2,[this3,this7,this8,this9,this10,this11,this12,this14,this15,new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("run-haxelib"),"path ...args","invoke a haxelib at a given path following haxelib's conventions",function(args11) {
		if(args11.length == 0) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no path supplied",{ fileName : "Cli.hx", lineNumber : 214, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
...
lix_client_DownloadedArchive.readInfos = function(root,lib) {
	...
	if(files.indexOf("haxelib.json") != -1) {
		...
		return new lix_client_ArchiveInfos(info.name,info.version,tmp,function(ctx) {
		...
		},info.postDownload,info.postInstall);
	} else if(files.indexOf("package.json") != -1) {
		var info1 = JSON.parse(js_node_Fs.readFileSync("" + root + "/package.json",{ encoding : "utf8"}));
		var _g1 = info1.name;
		var _g2 = info1.version;
		return new lix_client_ArchiveInfos(_g1,_g2,guessClassPath(),function(_) {
			return haxe_ds_Option.None;
		},null,null);
	} else {
		var o = lib.name;
		...
		return new lix_client_ArchiveInfos(_g11,_g3,guessClassPath(),function(_1) {
			return haxe_ds_Option.None;
		},null,null);
	}
};
...
lix_client_Download.download = function(url,handler) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
		...
		var fail = function(e) {
			var fail1 = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to download " + url + " because " + e.message,e,{ fileName : "Download.hx", lineNumber : 269, className : "lix.client.Download", methodName : "download"}));
			cb(fail1);
		};
		...
		req.on("response",function(res) {
			if(res.statusCode >= 400) {
				var tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(res.statusCode,res.statusMessage,res,{ fileName : "Download.hx", lineNumber : 280, className : "lix.client.Download", methodName : "download"}));
				cb(tmp);
			} else {
...
lix_client_Libraries.prototype = {
	...
	,installArchive: function(a,$as,withHaxeLibDependencies) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(this.downloadArchive(a),function(a1) {
			...
			return tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(haxelibs == null ? tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise)) : lix_client_sources_Haxelib.installDependencies(haxelibs,_gthis,function(s1) {
				...
				var lines = [];
				var _g21 = infos.runAs({ libRoot : _gthis.scope.interpolate(DOWNLOAD_LOCATION)});
				switch(_g21[1]) {
				case 0:
					var v2 = _g21[2];
				...
				if(_g3 != null) {
					var v3 = _g3;
					lines.push("# @" + "post-install" + ": cd " + DOWNLOAD_LOCATION + " && " + interpolate(v3));
				}
				var content = lines.concat(["# @" + "install" + ": lix --silent download \"" + tink__$Url_Url_$Impl_$.toString(a1.job.normalized) + "\" into " + a1.relRoot,"-D " + name + "=" + version,"-cp " + DOWNLOAD_LOCATION + "/" + infos.classPath,extra]).concat(deps).join("\n");
				js_node_Fs.writeFileSync(hxml,content);
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise));
			}),function(_3) {
...
lix_client_sources_Haxelib.processUrl = function(url) {
	...
	if(_g == null) {
		...
		if(_hx_tmp.length == 1) {
			var v = _hx_tmp[0];
			return lix_client_sources_Haxelib.getArchive(v,url.hash,{ host : url.host});
		} else {
...
lix_client_sources_Haxelib.getArchive = function(name,version,options) {
	if(version == null) {
		...
		var v = version;
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success({ url : tink__$Url_Url_$Impl_$.fromString("https://" + lix_client_sources_Haxelib.HOST + "/p/" + name + "/" + version + "/download/"), normalized : options != null && options.host != null ? tink__$Url_Url_$Impl_$.fromString("haxelib://" + options.host + "/" + name + "#" + version) : tink__$Url_Url_$Impl_$.fromString("haxelib:" + name + "#" + version), dest : lix_client_ArchiveDestination.Fixed([name,version,"haxelib"]), kind : lix_client_ArchiveKind.Zip, lib : new lix_client_LibVersion(haxe_ds_Option.Some(name),haxe_ds_Option.Some(version))}));
	}
};
	...
	while(_g1 < _g2.length) {
		...
		_g.push(tink_core__$Future_Future_$Impl_$.async((function(name1) {
			return function(cb) {
				...
				var version = tink__$Url_Url_$Impl_$.fromString(haxelibs[name1[0]]);
